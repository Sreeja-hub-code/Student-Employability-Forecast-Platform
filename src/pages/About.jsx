      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            using real academic data with 88% accuracy.
          </motion.p>
        </div>
                ...
                <div className="bg-gradient-to-br from-blue-500 to-purple-500 p-1 rounded-2xl">
                  <div className="bg-white rounded-xl p-6 h-full">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      ...
                      advanced machine learning algorithms with 88% accuracy.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="bg-white rounded-xl p-6 h-full">
                    ...
                    <ul className="text-gray-600 space-y-3">
                      ...
                      <li className="flex items-center">
                        ...
                        <strong>SVM algorithm</strong> achieving 88% prediction accuracy
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-br from-purple-500 to-pink-500 p-1 rounded-2xl">
                  <div className="bg-white rounded-xl p-6 h-full">
                    ...
                    <ul className="text-gray-600 space-y-3">
                      <li className="flex items-center">
                        <span className="bg-blue-100 text-blue-600 px-2 py-1 rounded-md text-sm font-semibold mr-3">88%</span>
                ...
                <div className="bg-gradient-to-r from-cyan-500 to-blue-500 rounded-2xl p-6 text-white transform hover:scale-105 transition-transform duration-300">
                  ...
                  <p className="text-cyan-50 leading-relaxed">
                    ...
                    <strong> 88% accuracy</strong> in placement prediction using comprehensive 
        ...
        >
          ...
          <p className="text-blue-100 text-sm">
            Empowering students with 88% accurate data-driven career insights
          </p>
